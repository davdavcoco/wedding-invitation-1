        ...
        <main className=" bg-black text-white">
            ...
            <section className="font-DMSans_Thin px-8 md:px-24 xl:px-16">
                <div className=" py-10 bg-black block xl:inline-block md:inline-block">
                    ...
                    <h1 className="xl:text-7xl py-2 font-thin md:text-7xl sm:text-4xl text-5xl hidden md:block xl:block">designed authenticly.</h1>
                    <h1 className="xl:text-7xl py-2 font-thin md:text-7xl text-3xl xl:hidden md:hidden sm:block">Where iconic brand designed authenticly.</h1>
                </div>
            </section>
                ...
                <div className="grid grid-cols-12 xl:gap-8 md:gap-8 sm:gap-4 py-10">
                    ...
                    <div className="md:col-start-7 xl:col-start-7 xl:col-span-3 md:col-span-3 col-span-12">
                        <h5 className="text-xl font-thin md:text-xl font-DMSans_Thin">
                            Fanrong is a brand and design office for driving change through creative problem solving
                        </h5>
                    </div>
                    <div className="md:col-start-10 xl:col-start-10 xl:col-span-3 md:col-span-3 col-span-12">
                        <h5 className="text-xl font-thin md:text-xl font-DMSans_Thin">
                            We help business convey their narativeness with clarity, enchancing with their visual appeal, and captivating their audience
                        </h5>
                    </div>
                </div>
            </section>
            ...
            <section className="font-DMSans_Thin py-10 px-8 md:px-24 xl:px-16">
                <div className="grid grid-cols-12 xl:gap-4 md:gap-4 md:px-0 xl:px-0 pb-0 lg:pb-20 md:pb-20">
                    ...
                    <div className="col-span-12 xl:col-span-4 md:col-span-4 pb-8 lg:pb-0 md:pb-0">
                        <a href="/toekoe/">
                            <Image src={toekoe} className="rounded-sm object-cover h-full w-full" alt="toekoe portfolio" />
                        </a>
                    ...
                    <div className="col-span-12 xl:col-span-4 md:col-span-4 pb-8 lg:pb-0 md:pb-0">
                        <a href="/creabiz/">
                            <Image src={creabiz} className="rounded-sm object-cover h-full w-full" alt="creabiz portfolio" />
                        </a>
                    ...
                    <div className="col-span-12 xl:col-span-4 md:col-span-4 pb-8 lg:pb-0 md:pb-0">
                        <a href="/gerbang-naga/">
                            <Image src={gerbang_naga} className="rounded-sm object-cover h-full w-full " alt="gerbang naga portfolio" />
                        </a>
                        <div className="flex justify-between">
                            <h3 className="text-xl font-thin">
                                <a href="/gerbang-naga/">Gerbang Naga</a>
                            </h3>
                ...
                <div className="grid grid-cols-12 xl:gap-4 md:gap-4 pb-0 xl:pb-20 md:pb-20 bg-black">
                    <div className="col-span-12 xl:col-span-4 md:col-span-4 pb-8 lg:pb-0 md:pb-0">
                        <a href="/tais-timor/">
                            <Image src={tais_timor} className="rounded-sm object-cover h-full w-full" alt="tais timor portfolio" />
                        </a>
                        <div className="flex justify-between">
                            <h3 className="text-xl font-thin">
                                <a href="/tais-timor/">Tais Timor</a>
                            </h3>
                            <a className="text-xl font-thin" href="/tais-timor">
                                +
                            </a>
                        </div>
                    </div>
                    <div className="col-span-12 xl:col-span-4 md:col-span-4 pb-8 lg:pb-0 md:pb-0">
                        <a href="/grand-batang-city/">
                            <Image src={grand_batang_city} className="rounded-sm object-cover h-full w-full" alt="grand batang city portfolio" />
                        </a>
                        <div className="flex justify-between">
                            <h3 className="text-xl font-thin">
                                <a href="/grand-batang-city/">Grand Batang City</a>
                            </h3>
                            <a className="text-xl font-thin" href="/grand-batang-city">
                                +
                            </a>
                        </div>
                    </div>
                    <div className="col-span-12 xl:col-span-4 md:col-span-4 pb-8 lg:pb-0 md:pb-0">
                        <a href="/hooray/">
                            <Image src={hooray} className="rounded-sm object-cover h-full w-full" alt="hooray portfolio" />
                        </a>
                        <div className="flex justify-between">
                            <h3 className="text-xl font-thin">
                                <a href="/hooray/">Hooray</a>
                            </h3>
                            <a className="text-xl font-thin" href="/hooray">
                                +
                            </a>
                        </div>
                    </div>
                        ...
                        <Accordion type="single" collapsible>
                            <div className="xl:flex xl:justify-around gap-8 xl:pb-6">
                                <AccordionItem value="item-1" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Strategy</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Meaningful impact begins with refining ideas.</AccordionContent>
                                ...
                                <AccordionItem value="item-2" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Verbal Identity</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Your words reflect your character</AccordionContent>
                                    <div className="pb-0.5 bg-gradient-to-r from-orange-950 to-orange-700  border-r-black"></div>
                                </AccordionItem>
                            </div>
                            <div className="xl:flex xl:justify-around gap-8 xl:pb-6">
                                <AccordionItem value="item-3" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Visual Identity</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Your visuals reflects your company’s Quality</AccordionContent>
                                    <div className="pb-0.5 bg-gradient-to-r from-orange-950 to-orange-700  border-r-black"></div>
                                </AccordionItem>
                                <AccordionItem value="item-4" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Marketing Tools Design</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Luck happens when preparation meets opportunity</AccordionContent>
                                    <div className="pb-0.5 bg-gradient-to-r from-orange-950 to-orange-700  border-r-black"></div>
                                </AccordionItem>
                            </div>
                            <div className="xl:flex xl:justify-around gap-8 xl:pb-6">
                                <AccordionItem value="item-5" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Digital Design & Development</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Catch global-sized market opportunities.</AccordionContent>
                                    <div className="pb-0.5 bg-gradient-to-r from-orange-950 to-orange-700  border-r-black"></div>
                                </AccordionItem>
                                <AccordionItem value="item-6" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Activation</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Achieve goals with a well-planned content strategy.</AccordionContent>
                                    <div className="pb-0.5 bg-gradient-to-r from-orange-950 to-orange-700  border-r-black"></div>
                                </AccordionItem>
                            </div>
                            <div className="xl:flex xl:justify-around gap-8 xl:pb-6">
                                <AccordionItem value="item-7" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Workshop & Class</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Investing in people and knowledge is the ultimate investment.</AccordionContent>
                                    <div className="pb-0.5 bg-gradient-to-r from-orange-950 to-orange-700  border-r-black"></div>
                                </AccordionItem>
                                <AccordionItem value="item-8" className="w-full border-none">
                                    <AccordionTrigger>
                                        <span className="xl:text-2xl md:text-2xl text-xl">Supervision</span>
                                    </AccordionTrigger>
                                    <AccordionContent>Your Brand Visuals discussing partner</AccordionContent>
                                    <div className="pb-0.5 bg-gradient-to-r from-orange-950 to-orange-700  border-r-black"></div>
                                </AccordionItem>
                            </div>
                        </Accordion>
                    ...
                    <div className="col-span-12 xl:flex xl:justify-between md:flex md:justify-between sm:text-center">
                        ...
                        <div className="col-span-2 text-center">
                            <button className="bg-green-500 text-white rounded-full text-3xl font-bold py-2 px-8">
                                <a href="https://wa.me/6285730265328" className="flex gap-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 self-center" fill="currentColor" viewBox="0 0 24 24">
